...
def rotate_image(image, angle):
    ...
    # rotate the image
    rotated_image = cv.warpAffine(image, rotation_matrix, (width, height), borderValue=(255, 255, 255))
    ...
    translated_image = cv.warpAffine(rotated_image, translation_matrix, (width, height), borderValue=(255, 255, 255))
